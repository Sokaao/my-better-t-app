		...
		<>
			...
			<main>
				<section className="s-page-hero" style={{ textAlign: "left", padding: "48px 0 24px" }}>
					<div
						className="s-wrap"
						style={{ maxWidth: 1600, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}
					>
						<div>
				...
				<section className="s-blk" style={{ paddingTop: 0 }}>
					<div className="s-wrap" style={{ maxWidth: 1600 }}>
						{loadError ? (
								...
								<table style={{ width: "100%", borderCollapse: "collapse" }}>
									<thead>
										<tr style={{ background: "var(--cream-2)", textAlign: "left" }}>
											<th style={{ padding: "10px 12px", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, color: "var(--faint)" }}>
												Client
											</th>
											<th style={{ padding: "10px 12px", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, color: "var(--faint)" }}>
												Automatisation

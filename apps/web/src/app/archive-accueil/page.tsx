	...
	return (
		<>
			...
			<section className="s-blk" id="preuves" style={{ paddingTop: 0 }}>
				<div className="s-wrap">
					<div className="s-sec-head rv">
						<span className="s-eyebrow">Aperçu</span>
						<h2>Ce que ça donne concrètement.</h2>
						<p>Des captures réelles, et des démonstrations d&apos;interface pour visualiser ce qui est livré.</p>
					</div>
					<div className="s-shots">
						...
						<div className="s-shot rv rv-d2">
							...
							<span className="s-ph-sub">Démonstration d&apos;interface pour suivre vos automatisations, avec validation humaine avant chaque envoi sensible.</span>
						</div>
						...
						<div className="s-shot rv rv-d4">
							...
							<span className="s-ph-sub">Heures récupérées, volume traité, temps de réponse : ce que le suivi mesure.</span>
						</div>
					</div>
				</div>
			</section>
				...
				<div className="s-wrap">
					<div className="s-founder rv">
						...
						<div>
							...
							<p>
								Je construis des systèmes qui prennent en charge tout ce qui entoure la comptabilité sans en faire partie : la collecte des pièces, les relances, le classement, les rappels d&apos;échéance. Je ne touche ni à vos écritures, ni à votre production, ni à votre jugement professionnel. Vous n&apos;achetez pas une prestation ponctuelle : vous installez une infrastructure qui tourne sur votre compte, à votre nom.
							</p>
						</div>
					</div>
				</div>
